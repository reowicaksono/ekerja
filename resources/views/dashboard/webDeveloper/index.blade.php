...
<?php 
    ...
    $peserta = auth()->user()->nama_kategori == 'web-developer';
                ...
                <div class="container-fluid">
                    ...
                    @if(session()->has('as'))
                        ...
                        <div class="alert alert-success alert-dismissible fade show">
                            Selamat !!! Anda mendapatkan Sertifikat, Silahkan cek di menu navbar 
                        ...
                        @else
                            <div class="alert alert-danger alert-dismissible fade show">
                                Mohon maaf Nilai Anda masih belum mencukupi untuk mendapatkan sertikat.
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                @forelse ($webdev as $results)
                                    <div class="row  align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <a href="/web-developer/show/{{$results->webdevs_id}}">{{$results->judul}}</a></div>
                                        </div>
                                        <div class="col">
